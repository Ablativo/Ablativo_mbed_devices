...
const char MQTT_SERVER_HOST_NAME[] = "  << YOUR HOST NAME >> ";
const char MQTT_CLIENT_ID[] = "mbed_boards";
const char MQTT_TOPIC_PUB[] = "/sensors";
const char MQTT_TOPIC_SUB[] = "/sensors";
 ...
 * "-----END CERTIFICATE-----\n";
 */
const char* SSL_CLIENT_CERT_PEM = " << YOUR CERTIFICATE >> ";
 ...
 * "-----END RSA PRIVATE KEY-----\n";
 */
const char* SSL_CLIENT_PRIVATE_KEY_PEM = " << YOUR KEY >> ";
